...
?>
<section class="service-reviews" data-section="reviews">
    <div class="container">
        <div class="service-reviews__debug" style="padding: 20px; background: #f0f0f0; margin: 20px 0; border: 2px dashed #ccc;">
            <h2 style="margin: 0 0 10px 0; color: #333;">🔧 Отзывы секция (Этап 2 - проверка рендера)</h2>
