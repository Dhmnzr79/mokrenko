	...
	<div class="container">
        <div class="consult__box bg-gradient-brand consult__box--with-doctor">
			...
			<div class="consult__layout">
				<div class="consult__left col-lg-8">
					<h2 class="consult__title">Запишитесь на<br> <span class="text-contrast">бесплатный осмотр</span> <br>к нашим врачам</h2>
				...
				<div class="consult__right col-lg-4">
					<div class="consult__card consult__card--right">
						<div class="consult__card-content">
