	...
	<div class="container">
		<div class="row header__row header__row--mobile">
			<div class="header__mobile-logo">
				<a href="<?php echo esc_url(home_url('/')); ?>" class="header__brand">
					<img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/svg/logo_mobile.svg" alt="" class="header__logo-img">
				</a>
			</div>
			<div class="header__mobile-actions">
				<a href="tel:+74950035476" class="header__mobile-phone">
					<img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/svg/phone.svg" alt="" class="header__mobile-icon">
				</a>
				<button class="header__mobile-menu" aria-label="Меню">
					<img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/svg/burger.svg" alt="" class="header__mobile-icon">
				</button>
			</div>
		</div>
	</div>
