...
<section class="section section--awards awards">
	<div class="container">
		<div class="row awards__header">
			<div class="col-sm-12 col-lg-12">
				<h2>Награды и достижения клиники</h2>
				<p>Признание профессионального сообщества и доверие пациентов</p>
			</div>
		</div>
		...
		<div class="row awards__grid">
			<div class="col-sm-6 col-lg-3">
				<div class="award-card">
					...
					<h3>Лучшая стоматологическая клиника 2023</h3>
					<p>Награда от Ассоциации стоматологов России за высокое качество услуг</p>
				</div>
			</div>
			<div class="col-sm-6 col-lg-3">
				<div class="award-card">
					...
					<h3>Сертификат ISO 9001</h3>
					<p>Международный стандарт качества управления в медицинской сфере</p>
				</div>
			</div>
			<div class="col-sm-6 col-lg-3">
				<div class="award-card">
