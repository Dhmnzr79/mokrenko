	...
	<div class="container">
		...
		<div class="row benefits__row-201">
			<div class="col-sm-12 col-lg-8 bg-demo-1">
				<h2>Наши плюсы</h2>
				<p>Почему пациенты выбирают нас: опытные врачи, современное оборудование, комфортная атмосфера.</p>
			</div>
