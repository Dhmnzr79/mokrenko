	...
	<div class="container">
		<div class="row chief-doctor__header">
			<div class="col-sm-12 col-lg-12">
				<h2>Главный врач клиники</h2>
			</div>
		</div>
		
		<div class="row chief-doctor__content">
			<div class="col-sm-12 col-lg-6">
				<div class="chief-doctor__info">
					<h3>Дугинец Надежда Семеновна</h3>
					<p class="chief-doctor__position">Главный врач, врач-стоматолог-терапевт-эндодонт</p>
					<p class="chief-doctor__experience">Стаж: 15 лет</p>
					<div class="chief-doctor__description">
						<p>Опытный специалист с многолетним стажем работы в области стоматологии. Специализируется на эндодонтическом лечении, реставрации зубов и имплантологии.</p>
						<p>Кандидат медицинских наук, член международной ассоциации стоматологов. Провела более 3000 успешных операций.</p>
					</div>
					<div class="chief-doctor__facts">
						<div class="chief-doctor__fact">Более 3000 операций</div>
						<div class="chief-doctor__fact">Кандидат медицинских наук</div>
						<div class="chief-doctor__fact">Член международной ассоциации</div>
					</div>
					<div class="chief-doctor__actions">
						<a href="#" class="btn btn--primary">Записаться на прием</a>
						<a href="#" class="btn btn--secondary">Подробнее о враче</a>
					</div>
				</div>
			</div>
			<div class="col-sm-12 col-lg-6">
