			...
			<div class="col-sm-12 col-lg-4">
				<div class="benefits__card" style="background-color: #f0f0f0;">
					<div class="benefits__card-content">
						<div class="benefits__card-highlight">
							<span class="benefits__highlight-text">Гарантии и качество</span>
						</div>
						<div class="benefits__card-highlight">
							<span class="benefits__highlight-text">Стерильность, контроль качества, персональный подход.</span>
						</div>
					</div>
				</div>
			</div>
